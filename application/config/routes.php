...
$route['classes/create']['post'] = "classes/store";
$route['classes/:any'] = "classes/$1";
$route['classes/(:num)']['get'] = "classes/view/$1";
$route['classes/(:num)']['post'] = "classes/update/$1";
$route['classes/(:num)/delete'] = "classes/delete/$1";
$route['classes/:any'] = "classes/$1";
...
$route['child/(:num)/assignRoom']['post']='child/child/doAssignRoom/$1';
