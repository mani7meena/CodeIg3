...
class Reports extends CI_Controller
{
    ...
    public function index()
    {
        $data = array(
            ...
            'checkinout'=>$this->reports->result_sql('SELECT * FROM `child_checkin` as cc left join children as child on child.id = cc.child_id'),
             'food_reports'=>$this->reports->result_sql('SELECT * FROM `child_foodpref` as cf left join children as child on child.id = cf.child_id'),
